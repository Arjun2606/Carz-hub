...
<div class="image-grid">
    <div class="grid-row">
        ...
        <a href="renault kiger.php">
            <img src="cars\renault\kiger.jpg" alt="Image 1"></a>
            <h2>KIGER</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="renault kwid.php">
            <img src="cars\renault\kwid.jpg" alt="Image 1"></a>
            <h2>KWID</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="renault tribr.php">
            <img src="cars\renault\triber.jpg" alt="Image 1"></a>
            <h2>TRIBER</h2>
        </div>
    </div>
</div>
