...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">VOLVO</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="volvo c40.php">
            <img src="cars\volvo\c40-recharge.jpg" alt="Image 1"></a>
            <h2>C40</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="volvo s90.php">
            <img src="cars\volvo\s90.jpg" alt="Image 2"></a>
            <h2>S90</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="volvo xc40.php">
            <img src="cars\volvo\xc40-recharge.jpg" alt="Image 3"></a>
            <h2>XC40-RECHARGE</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="volvo xc60.php">
            <img src="cars\volvo\xc60.jpg" alt="Image 1"></a>
            <h2>XC60</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="volvo xc90.php">
            <img src="cars\volvo\xc90.jpg" alt="Image 2"></a>
            <h2>XC90</h2>
        </div>
