...
<body>
    <header class="container">
        ...
        <h1 STYLE="text-align:center;">TOYOTA</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
    <div class="image-grid">
        <div class="grid-row">
            <div class="grid-item" style="--navAni:6">
                <a href="toyota camry.php">
                <img src="cars\toyota\camry.jpg" alt="Image 1"></a>
                <h2>CAMRY</h2>
            </div>
            <div class="grid-item" style="--navAni:7">
                <a href="toyota glanza.php">
                <img src="cars\toyota\glanza.jpg" alt="Image 2"></a>
                <h2>GLANZA</h2>
            </div>
            <div class="grid-item" style="--navAni:8">
            <a href="toyota urban.php">
                <img src="cars\toyota\urban.jpg" alt="Image 3"></a>
                <h2>URBAN</h2>
            </div>
        </div>
        <div class="grid-row">
            <div class="grid-item" style="--navAni:9">
                <a href="toyota crysta.php">
                <img src="cars\toyota\crysta.jpg" alt="Image 1"></a>
                <h2>CRYSTA</h2>
            </div>
            <div class="grid-item" style="--navAni:10">
                <a href="toyota hycross.php">
                <img src="cars\toyota\hycross.jpg" alt="Image 2"></a>
                <h2>HYCROSS</h2>
            </div>
            <div class="grid-item" style="--navAni:11">
                <a href="toyota fortuner.php">
                <img src="cars\toyota\fortuner.jpg" alt="Image 3"></a>
                <h2>FORTUNER</h2>
            </div>
        </div>
        <div class="grid-row">
            <div class="grid-item" style="--navAni:12">
                <a href="toyota hilux.php">
                <img src="cars\toyota\hilux.jpg" alt="Image 1"></a>
                <h2>HILUX</h2>
            </div>
            <div class="grid-item" style="--navAni:13">
                <a href="toyota rumion.php">
                <img src="cars\toyota\rumion.jpg" alt="Image 2"></a>
                <h2>RUMION</h2>
            </div>
            <div class="grid-item" style="--navAni:14">
            <a href="toyota legender.php">
                <img src="cars\toyota\legender.jpg" alt="Image 3"></a>
                <h2>LEGENDER</h2>
            </div>
        </div>
        <div class="grid-row">
            <div class="grid-item" style="--navAni:15">
                <a href="toyota vellfire.php">
                <img src="cars\toyota\vellfire.jpg" alt="Image 1"></a>
                <h2>VELLFIRE</h2>
            </div>
            <div class="grid-item" style="--navAni:16">
                <a href="toyota landcruiser.php">
                <img src="cars\toyota\landcruiser.jpg" alt="Image 2"></a>
                <h2>LANDCRUISER</h2>
            </div>
