...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">JEEP</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="jeep compass.php">
            <img src="cars\jeep\compass.jpg" alt="Image 1"></a>
            <h2>COMPASS</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="jeep grand.php">
            <img src="cars\jeep\grand-cherokee.jpg" alt="Image 2"></a>
            <h2>GRAND-CHEROKEE</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="jeep meridian.php">
            <img src="cars\jeep\meridian.jpg" alt="Image 3"></a>
            <h2>MERIDIAN</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="jeep wrangler.php">
            <img src="cars\jeep\wrangler.jpg" alt="Image 1"></a>
            <h2>WRANGLER</h2>
        </div>
    ...
    </div> <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
