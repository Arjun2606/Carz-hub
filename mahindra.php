...
<body>
    <header class="container">
        ...
        <h1 STYLE="text-align:center;">MAHINDRA</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="Mahindra bolero.php">
            <img src="cars\mahindra\bolero.jpg" alt="Image 1"></a>
            <h2>BOLERO</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="Mahindra bolero-n.php">
            <img src="cars\mahindra\bolero-neo.jpg" alt="Image 2"></a>
            <h2>BOLERO-N</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="Mahindra thar.php">
            <img src="cars\mahindra\thar.jpg" alt="Image 3"></a>
            <h2>THAR</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="Mahindra scorpio.php">
            <img src="cars\mahindra\scorpio.jpg" alt="Image 1"></a>
            <h2>SCORPIO</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="Mahindra scorpio-n.php">
            <img src="cars\mahindra\scorpio-n.jpg" alt="Image 2"></a>
            <h2>SCORPIO-N</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="Mahindra xuv700.php">
            <img src="cars\mahindra\xuv700.jpg" alt="Image 3"></a>
            <h2>XUV700</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:12">
        <a href="Mahindra xuv300.php">
            <img src="cars\mahindra\xuv300.jpg" alt="Image 1"></a>
            <h2>XUV300</h2>
        </div>
        <div class="grid-item" style="--navAni:13">
         <a href="Mahindra xuv300-sport.php">
            <img src="cars\mahindra\xuv300-turbosport.jpg" alt="Image 1"></a>
            <h2>XUV300-TS</h2>
        </div>
        <div class="grid-item" style="--navAni:14">
        <a href="Mahindra xuv400.php">
            <img src="cars\mahindra\xuv400.jpg" alt="Image 1"></a>
            <h2>XUV400</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:15">
        <a href="Mahindra marazzo.php">
            <img src="cars\mahindra\marazzo.jpg" alt="Image 1"></a>
            <h2>MARAZZO</h2>
        </div>
        <div class="grid-item">
        </div>
