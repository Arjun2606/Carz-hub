...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">SKODA</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="skoda kodiaq.php">
            <img src="cars\skoda\kodiaq.jpg" alt="Image 1"></a>
            <h2>KODIAQ</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="skoda kushaq.php">
            <img src="cars\skoda\kushaq.jpg" alt="Image 2"></a>
            <h2>KUSHAQ</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="skoda slavia.php">
            <img src="cars\skoda\slavia.jpg" alt="Image 3"></a>
            <h2>SLAVIA</h2>
        </div>
    </div>
    <div class="grid-row">
