...
<div class="image-grid">
    <div class="grid-row">
        ...
        <a href="tata altroz.php">
            <img src="cars\tata\altroz.jpg" alt="Image 1"></a>
            <h2>ALTROZ</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="tata harrier.php"> 
            <img src="cars\tata\harrier.jpg" alt="Image 2"></a>     
            <h2>HARRIER</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="tata nexon.php">
            <img src="cars\tata\nexon.jpg" alt="Image 3"></a>
            <h2>NEXON</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="tata punch.php">
            <img src="cars\tata\punch.jpg" alt="Image 1"></a>
            <h2>PUNCH</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="tata tiago.php">
            <img src="cars\tata\tiago.jpg" alt="Image 2"></a>
            <h2>TIAGO</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="tata tigor.php">
            <img src="cars\tata\tigor.jpg" alt="Image 3"></a>
            <h2>TIGOR</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:12">
        <a href="tata safari.php">
            <img src="cars\tata\safari.jpg" alt="Image 1"></a>
            <h2>SAFARI</h2>
        </div>
