...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">KIA</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="kia sonet.php">
            <img src="cars\kia\sonet.jpg" alt="Image 1"></a>
            <h2>SONET</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="kia seltos.php">
            <img src="cars\kia\seltos.jpg" alt="Image 2"></a>   
            <h2>SELTOS</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="kia carens.php">
            <img src="cars\kia\carens.jpg" alt="Image 3"></a>
            <h2>CARENS</h2>
        </div>
    </div>
    <div class="grid-row">
        ...
        <a href="kia ev6.php">
            <img src="cars\kia\ev6.jpg" alt="Image 1"></a>
            <h2>EV6</h2>
        </div>
