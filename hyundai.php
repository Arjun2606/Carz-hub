...
<body>
    <header class="container">
        ...
        <h1 STYLE="text-align:center;">HYUNDAI</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="hyundai alcazar.php">
            <img src="cars\hyundai\alcazar.jpg" alt="Image 1"></a>
            <h2>ALCAZAR</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="hyundai aura.php">
            <img src="cars\hyundai\aura.jpg" alt="Image 2"></a>
            <h2>AURA</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="hyundai creta.php">
            <img src="cars\hyundai\creta.jpg" alt="Image 3"></a>
            <h2>CRETA</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="hyundai exter.php">
            <img src="cars\hyundai\exter.jpg" alt="Image 1"></a>
            <h2>EXTER</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="hyundai grand i10.php">
            <img src="cars\hyundai\grand i10.jpg" alt="Image 2"></a>
            <h2>GRAND-i10</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="hyundai i20.php">
            <img src="cars\hyundai\i.jpg" alt="Image 3"></a>
            <h2>i20</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:12">
        <a href="hyundai i20-n.php">
            <img src="cars\hyundai\in.jpg" alt="Image 1"></a>
            <h2>i20-n</h2>
        </div>
        <div class="grid-item" style="--navAni:13">
        <a href="hyundai ioniq.php">
        <img src="cars\hyundai\ioniq.jpg" alt="Image 1"></a>
            <h2>IONIQ</h2>
        </div>
        <div class="grid-item" style="--navAni:14">
        <a href="hyundai kona.php">
        <img src="cars\hyundai\kona.jpg" alt="Image 1"></a>
            <h2>KONA</h2>
        </div>
    </div>
    <div class="grid-row">
        ...
        <a href="hyundai tucson.php">
            <img src="cars\hyundai\tucson.jpg" alt="Image 1"></a>
            <h2>TUCSON</h2>
         </div>
        <div class="grid-item" style="--navAni:13">
        <a href="hyundai venue.php">
            <img src="cars\hyundai\venue.jpg" alt="Image 1"></a>
            <h2>VENUE</h2>
        </div>
        <div class="grid-item" style="--navAni:14">
        <a href="hyundai venue-n.php">
            <img src="cars\hyundai\venue-n.jpg" alt="Image 1"></a>
            <h2>VENUE-N</h2>
        </div>
    </div>
    <div class="grid-row">
    <div class="grid-item" style="--navAni:12">
    <a href="hyundai verne.php">
        <img src="cars\hyundai\verna.jpg" alt="Image 1"></a>
        <h2>VERNA</h2>
    </div>
    <div class="grid-item" style="--navAni:13">
        <h2></h2>
