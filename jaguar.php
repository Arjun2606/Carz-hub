...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">JAGUAR</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="jaguar f-pace.php">
            <img src="cars\jaguar\f-pace.jpg" alt="Image 1"></a>
            <h2>F-PACE</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="jaguar f-type.php">
            <img src="cars\jaguar\f-type.jpg" alt="Image 2"></a>
            <h2>F-TYPE</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="jaguar i-pace.php">
            <img src="cars\jaguar\i-pace.jpg" alt="Image 3"></a>
            <h2>I-PACE</h2>
        </div>
    </div>
