...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">CITROEN</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="citroen c3.php">
            <img src="cars\citroen\c3.jpg" alt="Image 1"></a>
            <h2>C3</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="citroen c5.php">
            <img src="cars\citroen\c5.jpg" alt="Image 2"></a>
            <h2>C5</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="citroen ec3.php">
            <img src="cars\citroen\ec3.jpg" alt="Image 3"></a>
            <h2>EC3</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="citroen exterior.php">
            <img src="cars\citroen\exterior.jpg" alt="Image 1"></a>
            <h2>EXTERIOR</h2>
        </div>
