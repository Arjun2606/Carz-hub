...
<div class="image-grid">
    <div class="grid-row">
        ...
        <a href="mg astor.php">
            <img src="cars\mg\astor.jpg" alt="Image 1"></a>
            <h2>ASTOR</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="mg gloster.php">
            <img src="cars\mg\gloster.jpg" alt="Image 2"></a>
            <h2>GLOSTER</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="mg hector.php">
            <img src="cars\mg\hector.jpg" alt="Image 3"></a>
            <h2>HECTOR</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="mg hector-plus.php">
            <img src="cars\mg\hector-lite.jpg" alt="Image 1"></a>
            <h2>HECTOR-LITE</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="mg zs.php">
            <img src="cars\mg\zs.jpg" alt="Image 1"></a>
            <h2>ZS</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="mg comet.php">
            <img src="cars\mg\comet.jpg" alt="Image 1"></a>
            <h2>COMET</h2>
        </div>
    </div>
</div>
