...
<body>
    <header class="container">
        ...
        <h1 STYLE="text-align:center;">HONDA</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="honda amaze.php">
            <img src="cars\honda\amaze.jpg" alt="Image 1"></a>
            <h2>AMAZE</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="honda city.php">
            <img src="cars\honda\city.jpg" alt="Image 2"></a>
            <h2>CITY</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="honda hgv.php">
            <img src="cars\honda\hgv.jpg" alt="Image 3"></a>
            <h2>CITY-HGV</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="honda elevate.php">
            <img src="cars\honda\elevate.jpg" alt="Image 1"></a>
            <h2>ELEVATE</h2>
        </div>
