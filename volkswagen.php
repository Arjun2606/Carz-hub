...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">VOLKSWAGEN</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="volkswagen taigun.php">
            <img src="cars\volkswagen\taigun.jpg" alt="Image 1"></a>
            <h2>TAIGUN</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="volkswagen virtus.php">
            <img src="cars\volkswagen\virtus.jpg" alt="Image 2"></a>
            <h2>VIRTUS</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="volkswagen tiguan.php">
            <img src="cars\volkswagen\tiguan.jpg" alt="Image 3"></a>
            <h2>TIGUAN</h2>
        </div>
    </div>
    <div class="grid-row">
