...
<header class="container">
        ...
        <h1 STYLE="text-align:center;">LAND-ROVER</h1>
    <!-- Repeat the above structure for the remaining 6 images and titles -->
</div>
<div class="image-grid">
    <div class="grid-row">
        <div class="grid-item" style="--navAni:6">
        <a href="landrover defender.php">
            <img src="cars\landrover\defender.jpg" alt="Image 1"></a>
            <h2>DEFENDER</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="landrover discovery.php">
            <img src="cars\landrover\discovery.jpg" alt="Image 2"></a>
            <h2>DISCOVERY</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="landrover discovery-exterior.php">
            <img src="cars\landrover\discovery-exterior.jpg" alt="Image 3"></a>
            <h2>DISCOVERY-EXTERIOR</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="landrover evoque.php">
            <img src="cars\landrover\evoque.jpg" alt="Image 1"></a>
            <h2>EVOQUE</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="landrover exterior.php">
            <img src="cars\landrover\rangerover-exterior.jpg" alt="Image 2"></a>
            <h2>RANGEROVER-EXTERIOR</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="landrover sport.php">
            <img src="cars\landrover\rangerover-sport.jpg" alt="Image 3"></a>
            <h2>RANGEROVER-SPORT</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:12">
        <a href="landrover velar.php">
            <img src="cars\landrover\rangerover-velar.jpg" alt="Image 1"></a>
            <h2>RANGEROVER-VELAR</h2>
        </div>
