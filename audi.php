...
<div class="image-grid">
    <div class="grid-row">
        ...
        <a href="audi a4.php">
            <img src="cars\audi\a4.jpg" alt="Image 1"></a>
            <h2>AUDI A4</h2>
        </div>
        <div class="grid-item" style="--navAni:7">
        <a href="audi a6.php">
            <img src="cars\audi\a6.jpg" alt="Image 2"></a>
            <h2>AUDI A6</h2>
        </div>
        <div class="grid-item" style="--navAni:8">
        <a href="audi a8.php">
            <img src="cars\audi\a8.jpg" alt="Image 3"></a>
            <h2>AUDI A8</h2>
        </div>
    </div>
    <div class="grid-row">
        <div class="grid-item" style="--navAni:9">
        <a href="audi e-tron.php">
            <img src="cars\audi\e-tron.jpg" alt="Image 1"></a>
            <h2>AUDI E-TRON</h2>
        </div>
        <div class="grid-item" style="--navAni:10">
        <a href="audi e-tron-gt.php">
            <img src="cars\audi\e-tron-gt.jpg" alt="Image 2"></a>
            <h2>AUDI E-TRON-GT</h2>
        </div>
        <div class="grid-item" style="--navAni:11">
        <a href="audi e-tron-sportback.php">
            <img src="cars\audi\e-tron-sportback.jpg" alt="Image 3"></a>
    ...
    <div class="grid-row">
        ...
        <a href="audi q3.php">
            <img src="cars\audi\q3.jpg" alt="Image 1"></a>
            <h2>AUDI Q3</h2>
        </div>
        <div class="grid-item" style="--navAni:13">
        <a href="audi q3-sportback.php">
            <img src="cars\audi\q3-sportback.jpg" alt="Image 2"></a>
            <h2>AUDI Q3-SPORTBACK</h2>
        </div>
        <div class="grid-item" style="--navAni:14">
        <a href="audi q5.php">
            <img src="cars\audi\q5.jpg" alt="Image 3"></a>
            <h2>AUDI Q5</h2>
        </div>
    </div>
    <div class="grid-row">
        ...
        <a href="audi q7.php">
            <img src="cars\audi\q7.jpg" alt="Image 1"></a>
            <h2>AUDI Q7</h2>
        </div>
        <div class="grid-item" style="--navAni:16">
        <a href="audi q8.php">
            <img src="cars\audi\q8.jpg" alt="Image 2"></a>
            <h2>AUDI Q8</h2>
        </div>
        <div class="grid-item" style="--navAni:17">
        <a href="audi q8-exterior.php">
            <img src="cars\audi\q8-exterior.jpg" alt="Image 2"></a>
            <h2>AUDI Q8-EXTERIOR</h2>
        </div>
    </div>
    <div class="grid-row">
    <div class="grid-item" style="--navAni:15">
    <a href="audi q8-sportback.php">
        <img src="cars\audi\q8-sportback.jpg" alt="Image 1"></a>
        <h2>AUDI Q8-SPORTBACK</h2>
    </div>
    <div class="grid-item" style="--navAni:16">
    <a href="audi rs5.php">
        <img src="cars\audi\rs5.jpg" alt="Image 2"></a>
        <h2>AUDI RS5</h2>
    </div>
    <div class="grid-item" style="--navAni:17">
    <a href="audi rs-q8.php">
        <img src="cars\audi\rs-q8.jpg" alt="Image 2"></a>
        <h2>AUDI RS-Q8</h2>
    </div>
</div>
<div class="grid-row">
<div class="grid-item" style="--navAni:15">
<a href="audi s5-sportback.php">
    <img src="cars\audi\s5-sportback.jpg" alt="Image 1"></a>
    <h2>AUDI S5-SPORTBACK</h2>
</div>
<div class="grid-item" style="--navAni:16">
     <h2></h2>
</div>
